...
![functional diagram](https://github.com/The-Assembly/Neural_network_with_R/blob/master/NeuralNetwork_with_R.jpg)
...
![alt-text](https://github.com/The-Assembly/Neural_network_with_R/blob/master/DigitRecognizer.gif)
